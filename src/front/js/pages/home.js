...
export const Home = () => {
	...
	<div className="container my-5">
		<section className="text-center text-white d-flex flex-column justify-content-center 
		align-items-center medium-background center-column">
		...
		<section className="container py-5">
			<h2 className="text-center strong-background">¿Por qué elegir nuestro módulo?</h2>
